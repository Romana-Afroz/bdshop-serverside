...
client.connect(err => {
  const serviceCollection = client.db("bdshop").collection("services");
  const orderCollection = client.db("bdshop").collection("orders");
  const testimonialCollection = client.db("bdshop").collection("testimonials");
  const adminCollection = client.db("bdshop").collection("admins");
